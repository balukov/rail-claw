...
Open your Railway domain + `/snapclaw` and log in with your `SETUP_PASSWORD`.
...
| Provider | Cost | Notes |
|---|---|---|
| **OpenAI Codex** | Free (ChatGPT subscription) | Recommended |
| **Anthropic API** | Pay per token | Reliable |
| **OpenAI API** | Pay per token | Reliable |
